  ...
  return (
    <>
      <div className="detail-anim mb-4">
        <span className="bg-secondary/30 text-primary px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-[0.2em]">
          Premium Technology
        </span>
      </div>

      <h1 className="text-5xl sm:text-7xl font-black text-dark tracking-tighter leading-none mb-6 detail-anim">
        {product.name}
      </h1>
