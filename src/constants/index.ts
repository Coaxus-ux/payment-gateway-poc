...
export const MOCK_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    longDescription: 'Designed for the digital nomad. The Aether Pack 20 features a suspended laptop compartment, hidden passport pocket, and recycled ocean-plastic fabric that is 100% waterproof.',
    price: 145.0,
    stock: 20,
